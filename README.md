...
| [optimizeRasterImage](https://github.com/svg/svgo/blob/master/plugins/optimizaRasgterImage.js) | Optimize embedded raster image in `<image>` tags based on custom attributes | `disabled` |
